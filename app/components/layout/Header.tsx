   ...
   return (
       <header className="container">
          <nav className="flex text-black h-[62px] items-center justify-between">
             ...
             <div className="block sm:hidden headerSvg h-[18px] w-[24px] after:top-[-9px] after:left-[-8px] after:h-[200%] after:w-[165%] space-y-1.5 " onClick={() => setBurgerVisible(!burgerVisible)}>
             ...
             <div className={`absolute inset-0 transition-all duration-300 h-full w-full opacity-[45%] burgerBlockingLayer ${burgerVisible ? "visible" : "invisible opacity-0"}`} onClick={() => setBurgerVisible(!burgerVisible)}/>

             <div className={`absolute right-0 top-0 transition-all duration-300 bg-white opacity-100  ${burgerVisible ? "w-[320px] visible" : "invisible"} h-full w-[0] space-y-1.5 `}>
                <ul className="flex flex-col ml-12 mr-3 text-left text-2xl mt-16">
                     <span className="headerBurgerLink justify-between mt-3">
                        <li>Store</li>
                   ...
                   <span className="headerBurgerLink justify-between mt-3">
                        <li>Bag</li>
                        <Link href="/" className="headerSvg after:top-[-4px] mr-1">
                   ...
                   <span className="headerBurgerLink justify-between mt-3">
                        <li>Saved</li>
                        <Link href="/" className="headerSvg mr-1">
                   ...
                   <span className="headerBurgerLink justify-between mt-3">
                        <li>Log out</li>
                        <svg fill="#000000" height={24} version="1.1" viewBox="0 0 384.971 384.971">
