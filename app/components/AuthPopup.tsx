   ...
   return (
       <div className="flex items-center justify-center absolute inset-0">
          ...
          <div className="relative  w-80 py-5 flex flex-col bg-white rounded-lg">
             <span className="absolute font-semibold text-xl top-3 right-4 cursor-pointer" onClick={() => dispatch(setAuthPopup(false))}>X</span>
             ...
             <button className="py-[3px] mx-5 mt-4 px-4 border-2 border-black  rounded-lg hover:bg-black hover:text-white transition-all duration-300" onClick={() => setIsRegister(!isRegister)}>
