...
const Header =  async () => {
   ...
   return (
       <header className="sm:w-[94%] sm:mx-auto h-[62px] bg-white w-[100%] sticky z-20 top-0">
          <nav className="flex text-black h-[62px] bg-white  items-center mx-4 sm:mx-0 justify-between">
             <Link href="/">
